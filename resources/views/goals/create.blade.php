    ...
    <form action=" {{ route('goals.store'); }} " method="POST">
        ...
        <table class="table-bordered">
            <tr>
                ...
                <td>
                    <input type="text" name="goal_id"  class="form-control"placeholder="รหัสทำประตู">
                </td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="goal_time" class="form-control" placeholder="เวลา">
                </td>
            </tr>
            <tr>
                <td>
                ...
                <td>
                    <input type="text" name="is_penalty" class="form-control" placeholder="ลูกโทษ">
                </td>
            </tr>
            <tr>
                <td>
